...
import { PersonAdd, Edit, Delete, Visibility, Close, TrendingUp, AccountBalance, History, Add } from "@mui/icons-material"
  ...
  return (
    <Section title="Customer Management" breadcrumbs={["Home", "Customers"]}>
      <div className="mb-4 flex justify-between items-center">
        ...
        <Button variant="contained" startIcon={<Add />} onClick={handleOpenAdd} disabled={isFetching}>
          Add Customer
        </Button>
      </div>
            ...
            {customerList.map((customer) => {
              ...
              return (
                <TableRow key={customer._id} hover>
                  ...
                  <TableCell>
                    <div className="text-sm">Rs {limit.toFixed(2)}</div>
                  </TableCell>
                  <TableCell>
                    <div className="space-y-1" style={{ minWidth: '120px' }}>
                      ...
                      />
                      <div className="text-xs text-slate-500">{debtPercentage.toFixed(1)}% used</div>
                    </div>
                  </TableCell>
                  <TableCell>
                    <Chip
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h6" className="text-orange-600">
                        Rs {Number(viewCustomer.current_balance || 0).toFixed(2)}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="caption" color="text.secondary">
                      ...
                      <Typography variant="h6">Rs {Number(viewCustomer.credit_limit || 0).toFixed(2)}</Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="caption" color="text.secondary">
                        Available Credit
                      ...
                      <Typography variant="h6" className="text-green-600">
                        Rs {Math.max(0, Number(viewCustomer.credit_limit || 0) - Number(viewCustomer.current_balance || 0)).toFixed(2)}
                      </Typography>
                    </Grid>
                  </Grid>
