            ...
            <TableBody>
              {loadingInventory ? (
                ...
                <TableRow key={row.sku} hover selected={selected.includes(row.sku)} style={{ opacity: row.is_active === false ? 0.6 : 1 }}>
                  ...
                  <TableCell align="right">Rs {Number(row.unit_cost || 0).toFixed(2)}</TableCell>
                  <TableCell align="right" className="font-semibold">
                    Rs {Number(row.selling_price || 0).toFixed(2)}
                  </TableCell>
                  <TableCell>
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        <TableCell align="right">{cost > 0 || price > 0 ? `Rs ${margin.toFixed(2)}${marginPct !== null ? ` (${marginPct.toFixed(1)}%)` : ""}` : '-'}</TableCell>
                        <TableCell align="right">Rs {stockValue.toFixed(2)}</TableCell>
                        <TableCell align="right">Rs {potentialValue.toFixed(2)}</TableCell>
